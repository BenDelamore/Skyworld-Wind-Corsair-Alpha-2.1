...
if x < 0 +50//global.edge
	{
		spd += max(0,(edgespeed1/10))
		x += lengthdir_x(spd,point_direction(x,y,global.edge,y))
	}
	
if x > room_width -50// - global.edge
	{
		spd += max(0,(edgespeed3/10))
		x += lengthdir_x(spd,point_direction(x,y,(room_width-global.edge),y))
	}

//abs(sign(vspd))+

if y < 0 +50//global.edge
	{
		spd += max(0,(edgespeed2/10))
		y += lengthdir_y(spd,point_direction(x,y,x,global.edge))
	}

if y > room_height -50//- global.edge
	{
		spd += max(0,(edgespeed4/10))
