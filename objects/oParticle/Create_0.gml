...
smoke_part = part_type_create()
	...
	part_type_direction(smoke_part,80,100,5,1)
	part_type_life(smoke_part,200,205)
	part_type_alpha2(smoke_part,1,0)
	//part_type_sprite(part,sWind,1,true,true)
	part_type_shape(smoke_part,pt_shape_cloud) 
	part_type_orientation(smoke_part,0,360,0,1,true)
...
part_emitter_stream(smoke,smoke_emitter,smoke_part,1)
